...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x11authorized_models\x18\x03 \x03(\tR\x10authorizedModels\"\x8b\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\aallowed\x18\x01 \x01(\bR\aallowed2\x80\v\n" +
	"\vAuthService\x12G\n" +
	"\x0eValidateAPIKey\x12\x1e.auth.v1.ValidateAPIKeyRequest\x1a\x15.auth.v1.UserIdentity\x12`\n" +
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*UserIdentity)(nil),                   // 1: auth.v1.UserIdentity
	(*CheckModelAuthorizationRequest)(nil), // 2: auth.v1.CheckModelAuthorizationRequest
	(*AuthorizationResult)(nil),            // 3: auth.v1.AuthorizationResult
	...
	(*DeleteAPIKeyRequest)(nil),            // 13: auth.v1.DeleteAPIKeyRequest
	(*ListAPIKeysRequest)(nil),             // 14: auth.v1.ListAPIKeysRequest
	(*ListAPIKeysResponse)(nil),            // 15: auth.v1.ListAPIKeysResponse
	(*APIKey)(nil),                         // 16: auth.v1.APIKey
	(*Group)(nil),                          // 17: auth.v1.Group
	(*CreateGroupRequest)(nil),             // 18: auth.v1.CreateGroupRequest
	(*UpdateGroupRequest)(nil),             // 19: auth.v1.UpdateGroupRequest
	(*DeleteGroupRequest)(nil),             // 20: auth.v1.DeleteGroupRequest
	(*ListGroupsRequest)(nil),              // 21: auth.v1.ListGroupsRequest
	(*ListGroupsResponse)(nil),             // 22: auth.v1.ListGroupsResponse
	(*AddUserToGroupRequest)(nil),          // 23: auth.v1.AddUserToGroupRequest
	(*RemoveUserFromGroupRequest)(nil),     // 24: auth.v1.RemoveUserFromGroupRequest
	(*Permission)(nil),                     // 25: auth.v1.Permission
	(*GrantPermissionRequest)(nil),         // 26: auth.v1.GrantPermissionRequest
	(*RevokePermissionRequest)(nil),        // 27: auth.v1.RevokePermissionRequest
	(*ListPermissionsRequest)(nil),         // 28: auth.v1.ListPermissionsRequest
	(*ListPermissionsResponse)(nil),        // 29: auth.v1.ListPermissionsResponse
	...
	(*v1.Empty)(nil),                       // 32: common.v1.Empty
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	4,  // 0: auth.v1.ListUsersResponse.users:type_name -> auth.v1.User
	16, // 1: auth.v1.ListAPIKeysResponse.api_keys:type_name -> auth.v1.APIKey
	17, // 2: auth.v1.ListGroupsResponse.groups:type_name -> auth.v1.Group
	25, // 3: auth.v1.ListPermissionsResponse.permissions:type_name -> auth.v1.Permission
	0,  // 4: auth.v1.AuthService.ValidateAPIKey:input_type -> auth.v1.ValidateAPIKeyRequest
	2,  // 5: auth.v1.AuthService.CheckModelAuthorization:input_type -> auth.v1.CheckModelAuthorizationRequest
	...
	7,  // 8: auth.v1.AuthService.UpdateUser:input_type -> auth.v1.UpdateUserRequest
	8,  // 9: auth.v1.AuthService.DeleteUser:input_type -> auth.v1.DeleteUserRequest
	9,  // 10: auth.v1.AuthService.ListUsers:input_type -> auth.v1.ListUsersRequest
	11, // 11: auth.v1.AuthService.CreateAPIKey:input_type -> auth.v1.CreateAPIKeyRequest
	13, // 12: auth.v1.AuthService.DeleteAPIKey:input_type -> auth.v1.DeleteAPIKeyRequest
	14, // 13: auth.v1.AuthService.ListAPIKeys:input_type -> auth.v1.ListAPIKeysRequest
	18, // 14: auth.v1.AuthService.CreateGroup:input_type -> auth.v1.CreateGroupRequest
	19, // 15: auth.v1.AuthService.UpdateGroup:input_type -> auth.v1.UpdateGroupRequest
	20, // 16: auth.v1.AuthService.DeleteGroup:input_type -> auth.v1.DeleteGroupRequest
	21, // 17: auth.v1.AuthService.ListGroups:input_type -> auth.v1.ListGroupsRequest
	23, // 18: auth.v1.AuthService.AddUserToGroup:input_type -> auth.v1.AddUserToGroupRequest
	24, // 19: auth.v1.AuthService.RemoveUserFromGroup:input_type -> auth.v1.RemoveUserFromGroupRequest
	26, // 20: auth.v1.AuthService.GrantPermission:input_type -> auth.v1.GrantPermissionRequest
	27, // 21: auth.v1.AuthService.RevokePermission:input_type -> auth.v1.RevokePermissionRequest
	28, // 22: auth.v1.AuthService.ListPermissions:input_type -> auth.v1.ListPermissionsRequest
	30, // 23: auth.v1.AuthService.CheckPermission:input_type -> auth.v1.CheckPermissionRequest
	1,  // 24: auth.v1.AuthService.ValidateAPIKey:output_type -> auth.v1.UserIdentity
	3,  // 25: auth.v1.AuthService.CheckModelAuthorization:output_type -> auth.v1.AuthorizationResult
	4,  // 26: auth.v1.AuthService.GetUser:output_type -> auth.v1.User
	4,  // 27: auth.v1.AuthService.CreateUser:output_type -> auth.v1.User
	4,  // 28: auth.v1.AuthService.UpdateUser:output_type -> auth.v1.User
	32, // 29: auth.v1.AuthService.DeleteUser:output_type -> common.v1.Empty
	10, // 30: auth.v1.AuthService.ListUsers:output_type -> auth.v1.ListUsersResponse
	12, // 31: auth.v1.AuthService.CreateAPIKey:output_type -> auth.v1.CreateAPIKeyResponse
	32, // 32: auth.v1.AuthService.DeleteAPIKey:output_type -> common.v1.Empty
	15, // 33: auth.v1.AuthService.ListAPIKeys:output_type -> auth.v1.ListAPIKeysResponse
	17, // 34: auth.v1.AuthService.CreateGroup:output_type -> auth.v1.Group
	17, // 35: auth.v1.AuthService.UpdateGroup:output_type -> auth.v1.Group
	32, // 36: auth.v1.AuthService.DeleteGroup:output_type -> common.v1.Empty
	22, // 37: auth.v1.AuthService.ListGroups:output_type -> auth.v1.ListGroupsResponse
	32, // 38: auth.v1.AuthService.AddUserToGroup:output_type -> common.v1.Empty
	32, // 39: auth.v1.AuthService.RemoveUserFromGroup:output_type -> common.v1.Empty
	25, // 40: auth.v1.AuthService.GrantPermission:output_type -> auth.v1.Permission
	32, // 41: auth.v1.AuthService.RevokePermission:output_type -> common.v1.Empty
	29, // 42: auth.v1.AuthService.ListPermissions:output_type -> auth.v1.ListPermissionsResponse
	31, // 43: auth.v1.AuthService.CheckPermission:output_type -> auth.v1.CheckPermissionResponse
