...
type BillingAccount struct {
	...
	BillingContact string                 `protobuf:"bytes,4,opt,name=billing_contact,json=billingContact,proto3" json:"billing_contact,omitempty"`
	Balance        float64                `protobuf:"fixed64,5,opt,name=balance,proto3" json:"balance,omitempty"`
	CreditBalance  float64                `protobuf:"fixed64,6,opt,name=credit_balance,json=creditBalance,proto3" json:"credit_balance,omitempty"`
...
func (x *BillingAccount) GetBalance() float64 {
	if x != nil {
		return x.Balance
	}
	return 0
...
type GetBillingAccountByUserRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetBillingAccountByUserRequest) Reset() {
	*x = GetBillingAccountByUserRequest{}
	mi := &file_billing_v1_billing_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBillingAccountByUserRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBillingAccountByUserRequest) ProtoMessage() {}

func (x *GetBillingAccountByUserRequest) ProtoReflect() protoreflect.Message {
	mi := &file_billing_v1_billing_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBillingAccountByUserRequest.ProtoReflect.Descriptor instead.
func (*GetBillingAccountByUserRequest) Descriptor() ([]byte, []int) {
	return file_billing_v1_billing_proto_rawDescGZIP(), []int{25}
}

func (x *GetBillingAccountByUserRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type CreateBillingAccountRequest struct {
	...
	InitialCredit  float64                `protobuf:"fixed64,4,opt,name=initial_credit,json=initialCredit,proto3" json:"initial_credit,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type UpdateBillingAccountRequest struct {
	...
	BalanceUpdated bool                   `protobuf:"varint,7,opt,name=balance_updated,json=balanceUpdated,proto3" json:"balance_updated,omitempty"` // flag to indicate balance should be updated
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *UpdateBillingAccountRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *UpdateBillingAccountRequest) GetBalance() float64 {
	if x != nil {
		return x.Balance
	}
	return 0
...
func (x *UpdateBillingAccountRequest) GetBalanceUpdated() bool {
	if x != nil {
...
const file_billing_v1_billing_proto_rawDesc = "" +
	...
	"\x0fbilling_contact\x18\x04 \x01(\tR\x0ebillingContact\x12\x18\n" +
	"\abalance\x18\x05 \x01(\x01R\abalance\x12%\n" +
	"\x0ecredit_balance\x18\x06 \x01(\x01R\rcreditBalance\x12\x1a\n" +
	"\bcurrency\x18\a \x01(\tR\bcurrency\x12\x16\n" +
	"\x06status\x18\b \x01(\tR\x06status\"*\n" +
	"\x18GetBillingAccountRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"9\n" +
	"\x1eGetBillingAccountByUserRequest\x12\x17\n" +
	...
	"\x0einitial_credit\x18\x04 \x01(\x01R\rinitialCredit\"\xde\x01\n" +
	...
	"\x0fbalance_updated\x18\a \x01(\bR\x0ebalanceUpdated\"\xed\x01\n" +
	"\aInvoice\x12\x0e\n" +
	...
	"\x05total\x18\x02 \x01(\x05R\x05total2\xe5\f\n" +
	...
	"\x11GetBillingAccount\x12$.billing.v1.GetBillingAccountRequest\x1a\x1a.billing.v1.BillingAccount\x12a\n" +
	"\x17GetBillingAccountByUser\x12*.billing.v1.GetBillingAccountByUserRequest\x1a\x1a.billing.v1.BillingAccount\x12[\n" +
...
var file_billing_v1_billing_proto_goTypes = []any{
	...
	(*GetBillingAccountByUserRequest)(nil), // 25: billing.v1.GetBillingAccountByUserRequest
	(*CreateBillingAccountRequest)(nil),    // 26: billing.v1.CreateBillingAccountRequest
	(*UpdateBillingAccountRequest)(nil),    // 27: billing.v1.UpdateBillingAccountRequest
	(*Invoice)(nil),                        // 28: billing.v1.Invoice
	(*InvoiceLineItem)(nil),                // 29: billing.v1.InvoiceLineItem
	(*GenerateInvoiceRequest)(nil),         // 30: billing.v1.GenerateInvoiceRequest
	(*GetInvoicesRequest)(nil),             // 31: billing.v1.GetInvoicesRequest
	(*ListInvoicesResponse)(nil),           // 32: billing.v1.ListInvoicesResponse
	(*v1.ProviderResponseCallback)(nil),    // 33: common.v1.ProviderResponseCallback
	(*v1.Empty)(nil),                       // 34: common.v1.Empty
}
var file_billing_v1_billing_proto_depIdxs = []int32{
	...
	29, // 4: billing.v1.Invoice.line_items:type_name -> billing.v1.InvoiceLineItem
	28, // 5: billing.v1.ListInvoicesResponse.invoices:type_name -> billing.v1.Invoice
	33, // 6: billing.v1.BillingService.OnProviderResponse:input_type -> common.v1.ProviderResponseCallback
	...
	25, // 21: billing.v1.BillingService.GetBillingAccountByUser:input_type -> billing.v1.GetBillingAccountByUserRequest
	26, // 22: billing.v1.BillingService.CreateBillingAccount:input_type -> billing.v1.CreateBillingAccountRequest
	27, // 23: billing.v1.BillingService.UpdateBillingAccount:input_type -> billing.v1.UpdateBillingAccountRequest
	30, // 24: billing.v1.BillingService.GenerateInvoice:input_type -> billing.v1.GenerateInvoiceRequest
	31, // 25: billing.v1.BillingService.GetInvoices:input_type -> billing.v1.GetInvoicesRequest
	34, // 26: billing.v1.BillingService.OnProviderResponse:output_type -> common.v1.Empty
	34, // 27: billing.v1.BillingService.RecordUsage:output_type -> common.v1.Empty
	3,  // 28: billing.v1.BillingService.GetUsage:output_type -> billing.v1.ListUsageResponse
	6,  // 29: billing.v1.BillingService.GetUsageAggregation:output_type -> billing.v1.ListUsageAggregationResponse
	8,  // 30: billing.v1.BillingService.EstimateCost:output_type -> billing.v1.CostEstimate
	9,  // 31: billing.v1.BillingService.CheckBudget:output_type -> billing.v1.BudgetStatus
	10, // 32: billing.v1.BillingService.CreateBudget:output_type -> billing.v1.Budget
	10, // 33: billing.v1.BillingService.UpdateBudget:output_type -> billing.v1.Budget
	34, // 34: billing.v1.BillingService.DeleteBudget:output_type -> common.v1.Empty
	16, // 35: billing.v1.BillingService.ListBudgets:output_type -> billing.v1.ListBudgetsResponse
	17, // 36: billing.v1.BillingService.CreatePricingRule:output_type -> billing.v1.PricingRule
	17, // 37: billing.v1.BillingService.UpdatePricingRule:output_type -> billing.v1.PricingRule
	34, // 38: billing.v1.BillingService.DeletePricingRule:output_type -> common.v1.Empty
	22, // 39: billing.v1.BillingService.ListPricingRules:output_type -> billing.v1.ListPricingRulesResponse
	23, // 40: billing.v1.BillingService.GetBillingAccount:output_type -> billing.v1.BillingAccount
	23, // 41: billing.v1.BillingService.GetBillingAccountByUser:output_type -> billing.v1.BillingAccount
	23, // 42: billing.v1.BillingService.CreateBillingAccount:output_type -> billing.v1.BillingAccount
	23, // 43: billing.v1.BillingService.UpdateBillingAccount:output_type -> billing.v1.BillingAccount
	28, // 44: billing.v1.BillingService.GenerateInvoice:output_type -> billing.v1.Invoice
	32, // 45: billing.v1.BillingService.GetInvoices:output_type -> billing.v1.ListInvoicesResponse
