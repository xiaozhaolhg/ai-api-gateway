...
> Admin API endpoints for provider management in gateway-service

## Purpose

HTTP endpoints in gateway-service for provider CRUD operations and health checks, proxied to provider-service via gRPC.
