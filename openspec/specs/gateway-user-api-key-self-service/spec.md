# gateway-user-api-key-self-service

## Purpose

User self-service API key management endpoints for the gateway-service.

## Service Responsibility

- Allow authenticated users to create, list, and delete their own API keys
- Use JWT authentication (not API key authentication) for these endpoints
...
|---------|----------|----------|
| auth-service | `CreateAPIKey`, `ListAPIKeys`, `DeleteAPIKey` | API key CRUD operations |

### Called By

| Service | Methods | Purpose |
|---------|----------|----------|
| Users (external) | HTTP endpoints | Self-service API key management |
