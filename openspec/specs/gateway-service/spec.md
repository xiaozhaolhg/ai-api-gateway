...
### Requirement: Non-Streaming Proxy via /v1/chat/completions

Gateway service SHALL proxy non-streaming requests to providers via the `/v1/chat/completions` endpoint.
...
### Requirement: Streaming Proxy via /v1/chat/completions

Gateway service SHALL proxy SSE streaming responses from providers via the `/v1/chat/completions` endpoint.
