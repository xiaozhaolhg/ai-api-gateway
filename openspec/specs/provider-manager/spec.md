...
> Provider CRUD operations with credential encryption and health checks in provider-service

## Purpose

Provider lifecycle management in provider-service including CRUD operations, UUID generation, timestamp tracking, credential encryption, and health checks.
